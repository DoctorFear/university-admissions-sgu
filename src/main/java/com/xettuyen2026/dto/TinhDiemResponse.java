...
public class TinhDiemResponse {
    ...
    // For VSAT display: tổ hợp gốc of the ngành, priority details
    private String tohopGoc;
    private String khuVucName;
    private String doiTuongName;
    private Double khuVucValue;
    private Double doiTuongValue;
    ...
    public Double getDiemNguong() {
        return diemNguong;
    }

    public void setDiemNguong(Double diemNguong) {
        this.diemNguong = diemNguong;
    }
    ...
    public List<Map<String, Object>> getToHopDetails() {
        return toHopDetails;
    }

    public void setToHopDetails(List<Map<String, Object>> toHopDetails) {
        this.toHopDetails = toHopDetails;
    }
    ...
    public String getDoiTuongName() {
        return doiTuongName;
    }

    public void setDoiTuongName(String doiTuongName) {
        this.doiTuongName = doiTuongName;
    }

    public Double getKhuVucValue() {
        return khuVucValue;
    }

    public void setKhuVucValue(Double khuVucValue) {
        this.khuVucValue = khuVucValue;
    }

    public Double getDoiTuongValue() {
        return doiTuongValue;
    }

    public void setDoiTuongValue(Double doiTuongValue) {
        this.doiTuongValue = doiTuongValue;
    }
}
